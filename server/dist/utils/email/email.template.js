...
exports.mentionNotificationTemplate = exports.loginTwoStepVerificationTemplate = exports.disableTwoStepVerificationTemplate = exports.enableTwoStepVerificationTemplate = exports.passwordChangedTemplate = exports.forgetPasswordTemplate = exports.updateEmailTemplate = exports.confirmEmailTemplate = void 0;
const confirmEmailTemplate = async ({ OTPCode }) => {
    return ` 
...
const updateEmailTemplate = async ({ OTPCode }) => {
    return ` 
  <div style="font-family: 'Segoe UI', Arial, sans-serif; padding: 30px; background-color: #f4f7fb; color: #333; max-width: 600px; margin: auto; border-radius: 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.08); text-align: center;">
...
const forgetPasswordTemplate = async ({ OTPCode }) => {
    return `
<div style="font-family: 'Segoe UI', Arial, sans-serif; padding: 30px; background-color: #f4f7fb; color: #333; max-width: 600px; margin: auto; border-radius: 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.08); text-align: center;">
...
const passwordChangedTemplate = async () => {
    return `
...
const enableTwoStepVerificationTemplate = async ({ OTPCode }) => {
    return `
  <div style="font-family: 'Segoe UI', Arial, sans-serif; padding: 30px; background-color: #f4f7fb; color: #333; max-width: 600px; margin: auto; border-radius: 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.08); text-align: center;">
...
exports.enableTwoStepVerificationTemplate = enableTwoStepVerificationTemplate;
const disableTwoStepVerificationTemplate = async ({ OTPCode }) => {
    return `
  <div style="font-family: 'Segoe UI', Arial, sans-serif; padding: 30px; background-color: #f4f7fb; color: #333; max-width: 600px; margin: auto; border-radius: 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.08); text-align: center;">
...
exports.disableTwoStepVerificationTemplate = disableTwoStepVerificationTemplate;
const loginTwoStepVerificationTemplate = async ({ OTPCode }) => {
    return `
  <div style="font-family: 'Segoe UI', Arial, sans-serif; padding: 30px; background-color: #f4f7fb; color: #333; max-width: 600px; margin: auto; border-radius: 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.08); text-align: center;">
...
exports.loginTwoStepVerificationTemplate = loginTwoStepVerificationTemplate;
const mentionNotificationTemplate = async (postLink, mentionedBy) => {
    return `
<div style="font-family: 'Segoe UI', Arial, sans-serif; padding: 30px; background-color: #f9fafc; color: #333; max-width: 600px; margin: auto; border-radius: 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.08); text-align: center;">
...
exports.mentionNotificationTemplate = mentionNotificationTemplate;
